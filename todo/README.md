...
| XOXO / Odzi (Speedo) | [`xoxo.md`](./xoxo.md) | 🟡 first inventory — official `pandora-full-fashion.myshopify.com` · Pandora-full-fashion V-1.5.0 · vendor password `1` · 0 yeni şema |
