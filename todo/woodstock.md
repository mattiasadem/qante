...
**Kapsam satırı:**  
`Woodstock · default (Light) · Woodstock-Shopify-theme/electronics · schema_name Woodstock 3.3.0 · theme_store_id null · home→PDP→PLP→collections→search→cart→about/contact→blog→404 · 48 obs · 162 PNG · 0 yeni şema · leftover: candidates/woodstock-leftovers.md`
